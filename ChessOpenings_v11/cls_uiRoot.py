...
from ChessWidgets.cls_uiCustomListView import ListView
...
class UIRoot(tk.Frame):
    def __init__(self):
        ...
        self.CustomListViewTest = ListView(self.TopLevelFrameRIGHT)
        self.CustomListViewTest.pack(fill=tk.BOTH, expand=True)

        self.CustomListViewTest.add_tile('Tile 1')
        self.CustomListViewTest.add_tile('Tile 2')
        self.CustomListViewTest.add_tile('Tile 3')
        self.CustomListViewTest.add_tile('Tile 4')
        self.CustomListViewTest.add_tile('Tile 5')
        self.CustomListViewTest.add_tile('Tile 6')
        self.CustomListViewTest.add_tile('Tile 7')
        self.CustomListViewTest.add_tile('Tile 8')
        self.CustomListViewTest.add_tile('Tile 9')
